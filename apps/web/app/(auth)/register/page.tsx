export default function RegisterPage() {
  return (
    <div className="mx-auto max-w-md rounded-lg bg-white p-6 shadow-sm">
      ...
      <p className="mt-2 text-sm text-slate-600">Start scheduling and publishing content with PostFlow.</p>
      <form className="mt-6 space-y-4">
        ...
        <div>
          ...
          <input className="mt-1 w-full rounded border border-slate-300 px-3 py-2" type="password" placeholder="Minimum 8 characters" />
        </div>
